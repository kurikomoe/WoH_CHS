 ...
 * Source code for file 'woh_chs_fixed.txt', last modified 1703159792.
 * Do not modify this file.
 */
#ifndef WOH_CHS_FIXED_H
#define WOH_CHS_FIXED_H
...
namespace bin2cpp
{
  ...
  const File & getWoh_chs_fixedTxtFile();
}; //bin2cpp

#endif //WOH_CHS_FIXED_H
